...
def run_all_tests():
    """Discovers and runs all test suites for Phases 1 through 7."""
    ...
    print("=" * 60)
    print("🚀 INITIATING MASTER TEST SUITE (PHASES 1 - 7)")
    print("=" * 60)
    ...
    if result.wasSuccessful():
        print("✅ ALL PHASES (1-7) PASSED SUCCESSFULLY!")
        sys.exit(0)
    else:
